...
export default function AddDeliveryAddress() { 
    const {
        ENGLISH: {            
            DeliveryAddress: { ADD_DELIVERYADDRESS_HEADING, FIRSTNAME_TEXT, FIRSTNAME_PLACEHOLDER,
                LASTNAME_TEXT, LASTNAME_PLACEHOLDER, EMAIL_TEXT, EMAIL_PLACEHOLDER, MOBILE_TEXT,
                MOBILE_PLACEHOLDER, ADDRESS_LINE1_TEXT, ADDRESS_LINE1_PLACEHOLDER, ADDRESS_LINE2_TEXT,
                 ADDRESS_LINE2_PLACEHOLDER, STATE_TEXT, STATE_PLACEHOLDER, PINCODE_TEXT, PINCODE_PLACEHOLDER},    
        },
      ...
      return(
          <div id="add-delivery-address-container">
            ...
            <p>{ADDRESS_LINE1_TEXT}</p>
                ...
                <span><input type="button" value="Add Address" className="input-button" /></span>
            </div>        
      );
}