      ...
      <div className="login-container">
          ...
          <div className="login-section">
            ...
            {(displayProfile) ?
              ...
              <p>
              <input type='button' value={LOGIN_PROFILE_BUTTON_TEXT} className='input-button'  />
              </p>
            ...
            <div className="input-section">
              ...
              <p>
              <input type='button' value={LOGIN_SENDOTP_BUTTON_TEXT} className='input-button' onClick={handleSendOTP} />
              </p>
            ...
            <div className="input-section">
              ...
              <p>
              <input type='button' value={LOGIN_BUTTON_TEXT} className='input-button' onClick={handleLogin} />
              </p>
              <h4>{LOGIN_INFO_TEXT}</h4>
            </div>)
          }
            ...
            <img src={google_login} alt={NO_SUCH_IMAGE} onClick={handleGoogleSignIn}></img>
            <img src={facebook_login} alt={NO_SUCH_IMAGE} onClick={handleFacebookSignIn}></img>
            </div> 
